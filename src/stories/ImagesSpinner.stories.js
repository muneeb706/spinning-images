...
export default {
  title: "components/ImagesSpinner",
  component: ImagesSpinner,
};

const Template = (args) => <ImagesSpinner {...args} />;
...
export const ImagesSpinnerDefault = Template.bind({});

ImagesSpinnerDefault.args = {
